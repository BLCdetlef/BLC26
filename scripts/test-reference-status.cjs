...
assert.throws(() => validateReference({ ...base, reference: { ...base.reference, qualifier: "exact" } }));
assert.throws(() => validateReference({ ...base, reference: { ...base.reference, exceedanceOperator: "<" } }));
